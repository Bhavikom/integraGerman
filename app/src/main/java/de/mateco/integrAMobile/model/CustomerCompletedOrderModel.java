...
public class CustomerCompletedOrderModel implements Parcelable
{
    private String AuftragNr, DatumAb, Einheit, EinsatzPLZ, Einsatzort, Gel_Gerat, Geraetegruppe, Hohengruppe, KaNr, KaP, KundenNr,
            LP, Mandant, Mietbeginn, Mietdauer, Mietende, NL, Region, Selbstbehalt, TP, Vers_LP, Vers_TP, Wunschgerat;
...
//            EinsatzPLZ, Einsatzort;
    ...
    public CustomerCompletedOrderModel() {
    }

    private CustomerCompletedOrderModel(Parcel in) {
        this.AuftragNr = in.readString();
        this.DatumAb = in.readString();
    ...
    public static final Creator<CustomerCompletedOrderModel> CREATOR = new Creator<CustomerCompletedOrderModel>() {
        public CustomerCompletedOrderModel createFromParcel(Parcel source) {
            return new CustomerCompletedOrderModel(source);
        }

        public CustomerCompletedOrderModel[] newArray(int size) {
            return new CustomerCompletedOrderModel[size];
        }
    };

    public static void extractFromJson(String jsonString, ArrayList<CustomerCompletedOrderModel> customerOpenOrders)
    {
        Gson gson = new Gson();
        Type typedValue = new TypeToken<ArrayList<CustomerCompletedOrderModel>>(){}.getType();
        ArrayList<CustomerCompletedOrderModel> listOfOpenOrder = gson.fromJson(jsonString, typedValue);
