...
public class PricingScreen3ObjectList implements Parcelable {
    public String getPriceServicePauschal() {
        return PriceServicePauschal;
    }

    public void setPriceServicePauschal(String priceServicePauschal) {
        PriceServicePauschal = priceServicePauschal;
    }

    private String PriceHandlingCheckBox, PriceServiceCheckBox, PriceHaftungsbegrenzungBoxStatus, PriceKalendertaeglichCheckBox,PriceServicePauschal;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.PriceServicePauschal);
    ...
    private PricingScreen3ObjectList(Parcel in) {
        ...
        this.PriceServicePauschal = in.readString();
