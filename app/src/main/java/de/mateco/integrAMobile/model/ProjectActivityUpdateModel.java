...
public class ProjectActivityUpdateModel implements Parcelable
{
    private String isWithoutKontactAndProject;

    public String isWithoutKontactAndProject() {
        return isWithoutKontactAndProject;
    }

    public void setWithoutKontactAndProject(String withoutKontactAndProject) {
        isWithoutKontactAndProject = withoutKontactAndProject;
    }
    ...
    private String AenderungMitarbeiter;
    ...
    private ProjectActivityUpdateModel(Parcel in) {
    ...
    public static final Creator<ProjectActivityUpdateModel> CREATOR = new Creator<ProjectActivityUpdateModel>() {
        public ProjectActivityUpdateModel createFromParcel(Parcel source) {
            return new ProjectActivityUpdateModel(source);
        }

        public ProjectActivityUpdateModel[] newArray(int size) {
            return new ProjectActivityUpdateModel[size];
        }
    };
}
