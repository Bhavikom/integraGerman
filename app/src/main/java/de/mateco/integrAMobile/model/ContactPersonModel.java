...
public class ContactPersonModel implements Parcelable
{
    ...
    private ArrayList<FeatureModel> Merkmal = new ArrayList<>();

    public ArrayList<FeatureModel> getFeatureList() {
        return Merkmal;
    }

    public void setFeatureList(ArrayList<FeatureModel> Merkmal) {
    ...
    private ContactPersonModel(Parcel in) {
        ...
        in.readTypedList(this.Merkmal, FeatureModel.CREATOR);
    }
