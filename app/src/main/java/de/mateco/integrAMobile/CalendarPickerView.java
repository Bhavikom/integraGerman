...
import de.mateco.integrAMobile.timesquare.DefaultDayViewAdapter;

import de.mateco.integrAMobile.timesquare.Logr;
import de.mateco.integrAMobile.timesquare.MonthCellDescriptor;

import de.mateco.integrAMobile.timesquare.MonthDescriptor;
import de.mateco.integrAMobile.timesquare.MonthView;
...
public class CalendarPickerView extends ListView {
  ...
  final List<Date> arrayStartEndDate = new ArrayList<>();
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    preferences = new PreferencesClass(context);
  ...
  public List<Date> getStartEndDates()
  {
      return arrayStartEndDate;
  }
    ...
    if (date != null)
    {
      ...
      if(GlobalClass.isFirsttime){
        ...
        try {
          ...
          //interfaceDateSelected intefaceDialog = (interfaceDateSelected)con;
          //intefaceDialog.onDateSelected(date);
