...
public class DailyAgendaTelephoneAdapter extends BaseAdapter
{
    private int resourceId;
    private List<TelefonateItem> listOfDailyAgenda;
    ...
    public DailyAgendaTelephoneAdapter(Context context, List<TelefonateItem> listOfDailyAgenda, int resourceId)
    {
