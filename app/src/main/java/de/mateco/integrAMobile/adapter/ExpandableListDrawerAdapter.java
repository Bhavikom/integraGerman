...
public class ExpandableListDrawerAdapter extends BaseExpandableListAdapter
{
                             ...
                             boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        /* below commented condition is old and commented on 12th July */
        ...
        /* below condition is new and added on 12th july*/
        if(matecoPriceApplication.isCustomerLoaded(DataHelper.isCustomerLoaded, false))
        {
            convertView.setBackgroundColor(context.getResources().getColor(android.R.color.transparent));
        }else {
            if((groupPosition == 1))
                if(childPosition == 0 || childPosition ==1 || childPosition ==6 ) {
                    convertView.setBackgroundColor(context.getResources().getColor(android.R.color.transparent));
                }else {
                    convertView.setBackgroundColor(context.getResources().getColor(R.color.gray));
            }else {
