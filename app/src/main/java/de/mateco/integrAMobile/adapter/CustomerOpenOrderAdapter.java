...
{
    private List<CustomerOpenOrderModel> listOfOpenOrders = new ArrayList<CustomerOpenOrderModel>();
    ...
    public CustomerOpenOrderAdapter(Context context, ArrayList<CustomerOpenOrderModel> listOfOpenOrders) {
        this.context = context;
        this.layoutInflater = LayoutInflater.from(context);
        this.listOfOpenOrders = listOfOpenOrders;
    }

    @Override
    public int getCount() {
        return listOfOpenOrders.size();
    }

    @Override
    public CustomerOpenOrderModel getItem(int position) {
        return listOfOpenOrders.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        if (convertView == null)
        {
            convertView = layoutInflater.inflate(R.layout.list_item_offer_open_order, null);
    ...
    private void initializeViews(CustomerOpenOrderModel object, ViewHolder holder,int position, View convertView)
    {
        //TODO implement
        ...
        holder.labelItemKaP.setText(object.getKaP());
        //holder.labelItemKundenNr.setText(object.getKundenNr());
        holder.labelItemLP.setText(object.getLP());
        //holder.labelItemMandant.setText(object.getMandant());
        holder.labelItemMietbeginn.
                setText(DataHelper.getDateFormatFromString(object.getMietbeginn(), output_format, input_format));
        holder.labelItemMietdauer.setText(object.getMietdauer());
        //holder.labelItemMietende.setText(DataHelper.getDateFormatFromString(object.getMietende(), output_format, input_format));
        ...
        holder.labelItemTP.setText(object.getTP());
        holder.labelItemVersLP.setText(object.getVers_LP());
        holder.labelItemVersTP.setText(object.getVers_TP());
