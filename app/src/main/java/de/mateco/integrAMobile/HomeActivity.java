...
import de.mateco.integrAMobile.fragment.ContactPersonSearchFragment;
...
public class HomeActivity extends BaseActivity implements ExpandableListView.OnChildClickListener, ExpandableListView.OnGroupClickListener, SettingAppFragment.OnLanguageSelected
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        GlobalClass.retainOrientation(HomeActivity.this);
    ...
    public void setChildGroupData()
    {
        ...
        child.add(language.getLabelContactPersonSearch());
        childItem.add(child);
        ...
        else if(groupPosition == 1 && childPosition == 6)
        {
            if(!preferences2.getisPrice().equalsIgnoreCase(""))
            {
                ...
                //{
                    ...
                    preferences2.clearCombobox();
                    clearDate();
                    fragment = new ContactPersonSearchFragment();
                    setTitle("Suche Ansprechpartner");
                    args.putString("Name", "Customer Offer");
                    tag = "Customer Offer";
               /* }
                else
    ...
    public void onLanguageUpdated()
    {
        ...
        childItem.get(1).set(6,language.getLabelContactPersonSearch());
