...
public class ProjectAddActivityModel implements Parcelable {
    ...
    public ProjectAddActivityModel() {
    }

    private ProjectAddActivityModel(Parcel in) {
    ...
    public static final Creator<ProjectAddActivityModel> CREATOR = new Creator<ProjectAddActivityModel>() {
        public ProjectAddActivityModel createFromParcel(Parcel source) {
            return new ProjectAddActivityModel(source);
        }

        public ProjectAddActivityModel[] newArray(int size) {
            return new ProjectAddActivityModel[size];
        }
    };
}
